...
export const CreateBondandAdminRole_CONTRACT_ABI = [
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'string', name: 'bondName', type: 'string' },
      { internalType: 'uint256', name: 'bondStartDate', type: 'uint256' },
      { internalType: 'uint256', name: 'bondMaturityDate', type: 'uint256' },
      { internalType: 'address', name: 'BondManager', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
